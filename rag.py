...
class Config:
    ...
    question = "用中文回答‘空气压缩机太响的原因’。请按照‘步骤-措施-参考-合格’的格式和顺序返回答案。"
    data_path = "./data/data-clean.txt"
...
def main_rag(question: str):
    ...
    # 设置查询
    retriever = VectorDBRetriever(vector_store, embed_model, query_mode="default", similarity_top_k=1)
    query_engine = RetrieverQueryEngine.from_args(retriever, llm=llm)
    response = query_engine.query(config.question)
    return str(response)
